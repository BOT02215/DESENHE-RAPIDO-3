...
function gotResult(error, result) {
    if(error) {
        ...
        console.log(result)
        drawnSketch = "Eu acho que é: " + result[0].label

        document.getElementById("seu_esboço").innerHTML = drawnSketch
        document.getElementById("precisão").innerHTML = "Porcentagem: " + result[0].confidence.toFixed(2)
    }
}
